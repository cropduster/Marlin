...
#define SENSORLESS_BACKOFF_MM  { 5, 5, 2 }  // (mm) Backoff from endstops before sensorless homing
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  // Add Probe Z Offset calibration to the Z Probe Offsets menu
    ...
    #define PROBE_OFFSET_WIZARD
      ...
      //
      #define PROBE_OFFSET_WIZARD_START_Z -3.8
