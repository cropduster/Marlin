...
#define STRING_CONFIG_H_AUTHOR "(mkuebbeler, Bear SKR OmniaDrop Bltouch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR OmniaBear"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  21.44,  24.75 }
    #define DEFAULT_Ki_LIST {   3.25,   3.25 }
    #define DEFAULT_Kd_LIST { 35.35, 68.01 }
  #else
    #define DEFAULT_Kp  21.44
    #define DEFAULT_Ki  3.25
    #define DEFAULT_Kd 35.35
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 31.90
  #define DEFAULT_bedKi 1.32
  #define DEFAULT_bedKd 512.46
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 1033 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 800, 200, 2500 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 1000, 800, 200, 2500 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -32.4, -34.9, -2.463 }
