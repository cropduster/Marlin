...
#define STRING_CONFIG_H_AUTHOR "(Michael, Ender3 Hemera SKR1.4 BLtouch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender3 SKR-Hemera"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  17.96,  17.96 }
    #define DEFAULT_Ki_LIST {   1.35,   1.35 }
    #define DEFAULT_Kd_LIST { 59.70, 59.70 }
  #else
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 64.5, 0, -0.30 }
